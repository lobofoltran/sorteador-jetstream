    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Registre-se</a>
            @endif
            @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                @else 
                <div>
                    <div class="font-medium text-base text-gray-800">teste nome</div>
                    <div class="font-medium text-sm text-gray-500">teste@email.com</div>
                </div>
                @endauth
            </div>
